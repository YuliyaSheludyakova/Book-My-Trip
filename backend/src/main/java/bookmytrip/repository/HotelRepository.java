...
public interface HotelRepository extends EntryRepository<Hotel> {
	...
	default List<Hotel> filterByBreakfastIncl(
			List<Hotel> maybeHotels, Boolean breakfastIncl, String city) {
		if (maybeHotels != null && breakfastIncl != null) {
			maybeHotels.retainAll(
					findByCityAndBreakfastInclOrderByName(city, breakfastIncl));
	...
	private List<Hotel> findByCityAndBreakfastInclOrderByName(
			String city, boolean breakfastIncl) {
	...
	default List<Hotel> filterByStars(
			List<Hotel> maybeHotels, Integer stars, String city) {
		if (maybeHotels != null && stars != null) {
			maybeHotels.retainAll(findByCityAndStarsOrderByName(city, stars));
		} else if (stars != null) {
